...
-->
                    ...
                    <nav class="main-nav">
                        ...
                        -->
                            ...
                            <li class="scroll-to-section">
                                @auth
                                    <a style="color: black" href="{{url('/showcart', Auth::user()->id)}}">
                                        Cart{{$count}}
                                    </a>
                                @endauth
    ...
    <div id="top">
        <table align="center" bgcolor="yellow">
            ...
            <form id="orderForm" action="{{url('orderconfirm')}}" method="post">
            @csrf
            ...
            <div id="appear" align="center" style="padding: 10px; display: none;">
                ...
                <div style="padding: 10px;">
                    <input class="btn btn-success" value="Order Confirm">
    ...
    $("#orderForm").submit(function (event) {
        ...
        // Your additional logic before submitting the form
        // ...
